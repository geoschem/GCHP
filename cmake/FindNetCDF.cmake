...
if(NOT TARGET NetCDF-C)
    add_library(NetCDF-C SHARED IMPORTED GLOBAL)
...
if(NOT TARGET NetCDF-F)
    add_library(NetCDF-F SHARED IMPORTED GLOBAL)
...
# Some MAPL targets depend on NetCDF::NetCDF_Fortran. Therefore, create an alias with that name.
if(NOT TARGET NetCDF::NetCDF_Fortran)
    add_library(NetCDF::NetCDF_Fortran ALIAS NetCDF-F)
endif()

# Legacy MAPL variables.
